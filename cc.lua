...
local A =
    z:MakeWindow(
    {
        Name = "Blox Fruit (Silly Hub V2)",
        IntroEnabled = false,
        IntroText = "Silly Hub",
        IntroIcon = "rbxassetid://14004846142",
        HidePremium = false,
        SaveConfig = false,
        ConfigFolder = "OrionTest"
    }
)
local B = A:MakeTab({Name = "Main", Icon = "rbxassetid://14004846142", PremiumOnly = false})
...
function getBlueGear()
    if game.workspace.Map:FindFirstChild("MysticIsland") then
        for r, v in pairs(game.workspace.Map.MysticIsland:GetChildren()) do
            if v:IsA("MeshPart") and v.MeshId == "rbxassetid://14004846142" then
                return v
            end
        end
    end
...
local bZ = A:MakeTab({Name = "Shop", Icon = "rbxassetid://14004846142", PremiumOnly = false})
...
if Sea3 then
    local ci = A:MakeTab({Name = "Webhook", Icon = "rbxassetid://14004846142", PremiumOnly = false})
    ci:AddTextbox(
...
LoadedUiHub = true
z:Init()
print("cam on cai cak da sai scipr nhoa  Kính gửi mấy em skidder")